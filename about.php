		...
		<div class="container-fluid bottom-buffer full-screen">
			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1 donated-menu">
					This website was made to allow all people to donate to a cause or a charity of their choice without the use of money.
					The money which is generated from the website will go to the charities which they were voted for.
					The money will be donated to the corresponding organizations on a monthly basis, at the end of each month.
					As proof that the money is successfully being donated posts/screenshots will be made on my twitter, <a href="https://twitter.com/notjacktall" target="_blank">@notjacktall</a>, at the end of each month showing the transactions.
					One vote may not seem like much, but it all adds up. Potentially we could donate thousands and thousands of dollars to organizations
					that are in desperate need for money and support. Five seconds can truly make a difference. Thank you for your patience/donations.
					<br />
					<br />
					Thanks,
					<br />
